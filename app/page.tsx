...
function Work({ t, lang, jobRows, selectVehicle, notice }: { t: typeof el; lang: "el" | "en"; jobRows: Array<{ job: Job; vehicle: Vehicle | null; customer: Customer | null }>; selectVehicle: (id: string) => void; notice: (message: string) => void }) {
