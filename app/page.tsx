...
export default function Home() {
  ...
  function finishCreation(message: string, vehicleId?: string) {
    refreshRepository(); setCreation(null); setCreationScan(null); setCreationVehicleId(null); notice(message);
