...
export function createSeed({ now = new Date(), garageId = DEMO_GARAGE_ID } = {}) {
  ...
  const vehicles = [
    ...
    { id: "veh_audi", customer_id: "cus_andreas", plate: "PKE 520", make: "Audi", model: "A3", year: 2017, km: 118250, colour: "Ασημί", d: -23 },
    { id: "veh_merc", customer_id: "cus_eleni", plate: "ΜΡΑ 402", make: "Mercedes-Benz", model: "A200", year: 2019, km: 61304, colour: "Γκρι", d: -290 },
    { id: "veh_chr", customer_id: "cus_eleni", plate: "MNT 308", make: "Toyota", model: "C-HR", year: 2021, km: 38640, colour: "Λευκό", d: -68 },
    ...
    { id: "veh_mazda", customer_id: "cus_christina", plate: "LPA 927", make: "Mazda", model: "CX-30", year: 2020, km: 52780, colour: "Κόκκινο", d: -52 },
  ...
  const jobs = [
    ...
    { id: "job_mazda_brakes", vehicle_id: "veh_mazda", title: "Έλεγχος φρένων", status: "in_progress", km: 52780, sched: [0, 10, 0], d: -1 },
    ...
    { id: "job_transit_inspection", vehicle_id: "veh_transit", title: "Τεχνικός έλεγχος", status: "scheduled", km: 189300, sched: [4, 9, 0], d: -1 },
    { id: "job_bmw_ac", vehicle_id: "veh_audi", title: "Έλεγχος A/C", status: "done", km: 118250, done: [-18, 14, 30], d: -20 },
    { id: "job_merc_alignment", vehicle_id: "veh_merc", title: "Ευθυγράμμιση τροχών", status: "scheduled", km: 61304, sched: [5, 10, 30], d: -1 },
    { id: "job_fiesta_battery", vehicle_id: "veh_fiesta", title: "Αλλαγή μπαταρίας", status: "done", km: 103880, done: [-45, 11, 15], d: -48 },
    { id: "job_note_brakes", vehicle_id: "veh_merc", title: "Έλεγχος φρένων", status: "in_progress", km: 61304, sched: [0, 14, 0], d: -1 },
    { id: "job_mazda_service", vehicle_id: "veh_mazda", title: "Μικρό service", status: "done", km: 52780, done: [-40, 13, 0], d: -43 },
    { id: "job_chr_ac", vehicle_id: "veh_chr", title: "Διάγνωση A/C", status: "scheduled", km: 38640, sched: [6, 12, 0], d: -1 },
    { id: "job_yaris_tyres", vehicle_id: "veh_audi", title: "Έλεγχος ελαστικών", status: "scheduled", km: 118250, sched: [7, 15, 0], d: -1 },
  ].map((j) =>
    makeJob(
      {
        id: j.id,
  ...
  const notes = [
    ...
    { id: "not_mazda_2", vehicle_id: "veh_mazda", body: "Ακούγεται τρίξιμο στο φρενάρισμα σε χαμηλή ταχύτητα.", author: "Ανδρέας", d: -2 },
